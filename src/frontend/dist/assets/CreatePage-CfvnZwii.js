import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, g as cn, P as Primitive$1, h as useDirection, i as useControllableState, R as Root2$1, k as useId, l as useComposedRefs, A as Anchor, m as composeEventHandlers, n as useLayoutEffect2, o as Portal$1, p as reactDomExports, q as createPopperScope, s as createCollection, t as useCallbackRef, v as hideOthers, w as useFocusGuards, x as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, y as createContextScope$1, z as createSlot, C as Content, E as Arrow, G as useAuth, H as useNavigate, I as useCreateSkill, M as Mic, e as Button, L as LogIn, B as Badge, X, f as ue } from "./index-l4XOU5JU.js";
import { I as Input } from "./input-21yfx5Ev.js";
import { P as Primitive, L as Label, a as Plus } from "./label-DUjkM0lI.js";
/**
...
function CreatePage() {
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-h3 font-display", children: "Share Your Skills" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Sign in to record and share your 10-second skill tips." })
          ] }),
  ...
  const handleFileChange = async (e) => {
    ...
    if (!file.type.startsWith("audio/")) {
      ue.error("Please select an audio file.");
      return;
    }
    ...
    if (duration > 10) {
      ue.error("Audio must be 10 seconds or less.");
      return;
    }
    setAudioFile(file);
    setUploadDone(false);
    ...
    try {
      ...
      setUploadDone(true);
      setUploadProgress(null);
      ue.success("Audio ready to publish!");
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!uploadDone) {
      ue.error("Please upload an audio file first.");
      return;
    }
    try {
      await createSkill.mutateAsync({ title, audioUrl, category, tags });
      ue.success("Skill published! 🎉");
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-h2 font-display", children: "Share a Skill" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Record a 10-second audio tip and earn credits when others unlock it." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "skill-title", children: "Title *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "skill-title",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { children: [
              "Audio File *",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-normal text-xs", children: "(≤ 10 seconds)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: uploadDone && audioFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 28, className: "text-primary" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-sm", children: audioFile.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Uploaded successfully — click to replace" })
                  ] })
                ] }) : audioFile && uploadProgress !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Upload,
                    {
                      size: 28,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-center", children: audioFile.name }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { size: 28, className: "text-muted-foreground" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-sm", children: "Click to select audio" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "MP3, AAC, OGG — max 10 seconds" })
                  ] })
                ] })
              }
            )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: category, onValueChange: setCategory, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "create.category.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Pick a category" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Tags (optional, up to 5)" }),
            ...
            tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "gap-1", children: [
              "#",
              tag,
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              type: "submit",
              disabled: createSkill.isPending || !uploadDone || uploadProgress !== null,
